...
do i = 2, n
do j = 1, n-j+1
d_ytable(j,i) = d_table(j+1,i-1) - d_table(j,i-1)
enddo
enddo
...
do i = 2, n
do j = n, i, -1
d_ytable(j,i) = d_table(j,i-1) - d_table(j-1,i-1)
enddo
enddo
do i = 2, n
mult = mult * (u + real(i-2))/real(i-1)
